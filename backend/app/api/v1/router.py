...
from app.api.v1.endpoints import auth, companies, financials, valuations, analysis, advanced_valuations, earnings_quality, portfolios, watchlists, indian_market, ipo_primary_market, options_derivatives, realtime_data, technical_analysis, websocket_endpoints
...
api_router.include_router(websocket_endpoints.router, prefix="", tags=["websocket", "streaming", "realtime"])
